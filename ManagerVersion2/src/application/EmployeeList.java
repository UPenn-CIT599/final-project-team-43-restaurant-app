...
public class EmployeeList extends CSVReader {
	 ...
	 * "Employee List.csv" to generate its own arraylist for manager system
	 * presenting
	 */
	@Override
	...
	/**
	 * add new employee to the list and write into the employee List.csv Then the
	 * new employee will show on the Employee GUI
	 */
	 ...
	 */
	/*
	 * public static EmployeeControl assignEmployeeToCustomer() { EmployeeList list
	 * = new EmployeeList("Employee List.csv"); String customerID =
	 * Customer.getCustomer().getCustomerID(); for(int i = 0; i <
	 * list.employeeList.size(); i++) { if(list.employeeList.get(i).getOnDuty() &&
	 ...
	 * @param args
	 * 
	 *             public static void main(String[] args) { EmployeeList el = new
	 *             EmployeeList(); el.generateEmployeeList(); }
	 */
}
